...
void bestfit(list head,int memory_allocation);
...
int main()
{
    ...
    for(int i=0;i<limit1;i++)
    {
        ...
        bestfit(head,memory_allocation);
    }
...
while(temp->next!=NULL)
{
    ...
    {
       if(small>=temp->mem_segment-memory_allocation)
       {
        small=temp->mem_segment-memory_allocation;
       }
    }
}
temp1=head;
...
{
    temp1=temp1->next;
    if(small==temp1->mem_segment-memory_allocation)
    {
